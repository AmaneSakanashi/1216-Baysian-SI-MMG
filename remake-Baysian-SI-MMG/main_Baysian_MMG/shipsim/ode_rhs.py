...
class EssoOsakaMMG(object):
    ...
    def ode_rhs(self, x, action, wind, update_params):
        ### To prevent read-only error in ray
        ...
        delta_rudder, n_prop = action[0], action[1]
        Wind_Direction, Wind_velocity = wind[0], wind[1]
